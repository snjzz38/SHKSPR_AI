    ...
    def do_GET(self):
        ...
        try:
            ...
            if not transcript_data:
                raise Exception(f"All proxies failed. Last error: {last_error}" if last_error else "No working proxies found from the list.")

            # Correctly access the .text attribute from each snippet object
